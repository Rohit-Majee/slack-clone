...
function InviteModal({ channel, onClose }) {
  ...
  const handleInvite = async () => {
    ...
    try {
      ...
      setError("Failed to in vite users.");
    } finally {
      setIsInviting(false);
    }
  };
    ...
    <div className="create-channel-modal-overlay">
      <div className="create-channel-modal">
        ...
        <div className="create-channel-modal__form">
          {isLoadingUsers && (
            <div className="p-6 rounded-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white shadow-lg backdrop-blur-md max-w-sm text-center animate-pulse">
          ...
          {users.length === 0 && !isLoadingUsers && (
            <div className="p-6 rounded-2xl bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white shadow-lg backdrop-blur-md max-w-sm text-center">
